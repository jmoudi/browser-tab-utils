...
export const tabstoIgnore = new Set();

export const isIgnoreTab = (tabId) => tabstoIgnore.has(tabId);
export const removeFromIgnoreTabs = (tabId) => tabstoIgnore.delete(tabId);
export const addToIgnoreTabs = (tabId) => tabstoIgnore.add(tabId);

export const isWhiteListed = (url) => {
    const matches = options.whiteList.filter(pattern => pattern.test(url));
    return matches.length !== 0;
};

export const matchTitle = (openTab, signaledTab) => {
...
export const getHttpsTabId = (tab1, url1, tab2) => {
...
export const getPinnedTabId = (tab1, tab2) => {
...
export const getByAgeTabId = (tab1, tab2) => {
...
export const keepIfHttps = (tabToCloseUrl, tabToKeepurl) => {
...
export const keepIfPinnedTab = (tabToClose, tabToKeep) => {
...
export const getTabsPriority = (signaledTab, signaledTabUrl, openTab) => {
...
export const closeDuplicateTab = (tabsPriority) => {
...
export const manageUniqueTab = (matchingInfo) => {
...
export const searchAndCloseNewDuplicateTabs = async (searchInfo) => {
...
export const setupDuplicateTabs = async (duplicateGroupsTabs) => {
...
export const refreshDuplicateTabsInfo = async (windowId) => {
    const searchResult = await searchForDuplicateTabs(windowId, false);
